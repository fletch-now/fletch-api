...
export type ContractSearchMatch = components["schemas"]["ContractSearchMatch"];
export type ContractSearchPage = components["schemas"]["ContractSearchPage"];
export type ContractSearchResponse = components["schemas"]["ContractSearchResponse"];
export type ContractSearchQuery = Query<"/chains/{chainId}/search">;
...
export class FletchClient {
  ...
  async tokenDiscoveries(chainId: number = MAINNET_CHAIN_ID, query?: Query<"/chains/{chainId}/discoveries">): Promise<Body<"/chains/{chainId}/discoveries">> {
    return (await this.get("/chains/{chainId}/discoveries", requestOptions({ chainId }, query))).body;
  }
